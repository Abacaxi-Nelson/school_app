  ...
  Widget _getColumnBody() => Column(
        children: <Widget>[
          ...
          Padding(
            ...
            child: PhoneAuthWidgets.getLogo(logoPath: widget.logo, height: _height * 0.2),
          ),
...
//    _showSnackBar(phoneAuthDataProvider.message);
  ...
  onError() {
//    _showSnackBar(phoneAuthDataProvider.message);
    _showSnackBar("PhoneAuth error ${Provider.of<PhoneAuthDataProvider>(context, listen: false).message}");
  }
